...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\section{objective}
%To obtain a position of the MS student at the The Universit{\'e} Grenoble Alpes
\section{education}
...
%\runsubsection{}
\descript{}
Randomized and distributed optimization methods for machine learning
\section{Skills}
%\runsubsection{}
%\location{}
%\vspace{\topsep} % Hacky fix for awkward extra vertical space
...
\descript{Programming languages:} python, matlab, C/C++, T-SQL, \LaTeX\\
...
\begin{tightemize}
	\item 
\descript{Research group of randomized algorithms for distributed optimization problems}\\
...
\begin{tightemize}
	...
	\location{17 December 2019}
	\descript{}
	\item Talk: Accelerated coordinate descent with arbitrary sampling\\ 
	\location{18 March 2019}
\end{tightemize}
%\vspace{0.5em}
	\item
\descript{ Sixth International Conference on Continuous Optimization}\\
...
\item
%\vspace{0.5em}
\descript{Computer science conference for pupils}\\
\location{Moscow, June 2012}
%\vspace{0.5em}
\item
\descript{Computer science conference for pupils}\\
\location{Moscow, June 2011}
\end{tightemize}
